...
{
  counter = 0; //initial count to 0 again
  float number = (36 * y) / 360 ; //time of delay in milly//24 moves 480 angles   18 makes a complete cycle(360)
  Serial.println(number);
...
////////////////////////////////********
void RightCircle ()//assume that forward right function make car to move in circle just measure the time of this
{
  int i = 0;
  for (i = 0; i < 38; i++)
  {
...
void LeftCircle ()//assume that forward right function make car to move in circle just measure the time of this
{
  int i = 0;
  for (i = 0; i < 60; i++)
  {
