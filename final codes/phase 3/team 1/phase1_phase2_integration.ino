...
void loop()
{
  ...
  if (Serial.available() > 0)
  {
    ...
    data = 'S'; //to change value of data from previous step//or we can make the value of data=phase
    //phase 2
    if (phase == 'T') //waiting to know which character for driving in phase 2//this if statement will make the car move according to phase 2
    {
      delay (2000);
      speed = 50;
      while (1)
